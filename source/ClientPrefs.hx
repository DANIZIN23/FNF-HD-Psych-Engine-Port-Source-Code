...
class ClientPrefs {
	...
	public static var disablesDialogues:String = 'Story Mode';
	...
	public static function saveSettings() {
		...
		FlxG.save.data.disablesDialogues = disablesDialogues;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.impEvent != null) {
			impEvent = FlxG.save.data.impEvent;
		}
		if(FlxG.save.data.poleSpawn != null) {
			poleSpawn = FlxG.save.data.poleSpawn;
		}
		if(FlxG.save.data.HDIcons != null) {
			HDIcons = FlxG.save.data.HDIcons;
		}
		...
		if(FlxG.save.data.PicoPlayer != null) {
			PicoPlayer = FlxG.save.data.PicoPlayer;
		}
		...
		if(FlxG.save.data.disablesDialogues != null) {
			disablesDialogues = FlxG.save.data.disablesDialogues;
		}
